...
class TestDataLocalityPattern(unittest.TestCase):
    ...
    def test_get_particle_data(self):
        ...
        if p_id != inactive_particle_id : # ensure we are not testing the active particle
    ...
    def test_get_active_particles_data(self):
        ...
        self.assertTrue(any(d["id"] == p1_id and d["pos_x"] == 2 for d in active_data_after_remove))
