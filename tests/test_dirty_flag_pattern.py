...
class TestDirtyFlagPattern(unittest.TestCase):
    ...
    def test_initial_state_is_dirty_and_computes_on_first_get(self):
        ...
        self.assertTrue(obj.is_dirty(), "Object should be dirty initially for representation.")
        self.assertTrue(obj._is_world_transform_dirty, "Object should be dirty initially for world transform.")
        ...
        self.assertFalse(obj.is_dirty(), "Object representation should not be dirty after getting representation.")
        self.assertFalse(obj._is_world_transform_dirty, "Object world transform should not be dirty after getting representation.")
    ...
    def test_no_recomputation_if_not_dirty(self):
        ...
        self.assertFalse(obj.is_dirty(), "Object representation should remain not dirty.")
        self.assertFalse(obj._is_world_transform_dirty, "Object world transform should remain not dirty.")
    ...
    def test_setting_local_property_marks_transform_and_representation_dirty(self):
        ...
        self.assertTrue(obj.is_dirty(), "Representation should be dirty after changing local_x.")
        self.assertTrue(obj._is_world_transform_dirty, "World transform should be dirty after changing local_x.")
        ...
        self.assertFalse(obj.is_dirty(), "Representation should not be dirty after recomputing.")
        self.assertFalse(obj._is_world_transform_dirty, "World transform should not be dirty after recomputing.")
    ...
    def test_setting_name_marks_only_representation_dirty(self):
        ...
        obj.name = "NewNameObj"
        self.assertTrue(obj.is_dirty(), "Representation should be dirty after changing name.")
        # World transform should NOT be dirty just because name changed
        self.assertFalse(obj._is_world_transform_dirty, "World transform should NOT be dirty after changing name.")

        name_change_rep = obj.get_representation()
        expected_repr_name = "Object \'NewNameObj\' at world (10.00, 10.00), local (10.00, 10.00)"
    ...
    def test_setting_property_to_same_value_does_not_mark_dirty(self):
        ...
        obj.local_x = 100 
        self.assertFalse(obj.is_dirty(), "Representation should not be dirty if local_x is set to the same value.")
        self.assertFalse(obj._is_world_transform_dirty, "World transform should not be dirty if local_x is set to the same value.")
        ...
        obj.name = "StableObj" 
        self.assertFalse(obj.is_dirty())
        self.assertFalse(obj._is_world_transform_dirty) # Name change doesn't affect transform

        representation = obj.get_representation()
        expected_repr = "Object \'StableObj\' at world (100.00, 200.00), local (100.00, 200.00)"
        self.assertEqual(representation, expected_repr)
        self.assertFalse(obj.is_dirty())
        self.assertFalse(obj._is_world_transform_dirty)
    ...
    def test_parent_child_transform_dirty_propagation(self):
        ...
        self.assertFalse(parent_obj.is_dirty(), "Parent representation should be clean after initial get.")
        self.assertFalse(parent_obj._is_world_transform_dirty, "Parent transform should be clean after initial get.")
        self.assertFalse(child_obj.is_dirty(), "Child representation should be clean after initial get.")
        self.assertFalse(child_obj._is_world_transform_dirty, "Child transform should be clean after initial get.")
        
        expected_child_rep_initial = "Object 'Child' at world (15.00, 15.00), local (5.00, 5.00)"
        ...
        self.assertTrue(parent_obj.is_dirty(), "Parent representation should be dirty after local_x change.")
        self.assertTrue(parent_obj._is_world_transform_dirty, "Parent transform should be dirty after local_x change.")
        self.assertTrue(child_obj.is_dirty(), "Child representation should be dirty due to parent change.")
        self.assertTrue(child_obj._is_world_transform_dirty, "Child transform should be dirty due to parent change.")
        ...
        expected_child_rep_after_parent_move = "Object 'Child' at world (25.00, 15.00), local (5.00, 5.00)"
        ...
        self.assertFalse(child_obj.is_dirty(), "Child representation should be clean after its get_representation.")
        self.assertFalse(child_obj._is_world_transform_dirty, "Child transform should be clean after its get_representation.")
        
        # Parent's world transform was recomputed as a dependency, so it's clean.
        self.assertFalse(parent_obj._is_world_transform_dirty, "Parent's world transform should be clean after child's get_representation caused its update.")
        ...
        self.assertTrue(parent_obj.is_dirty(), "Parent's representation flag should still be true as only its transform was implicitly updated.")
        ...
        expected_parent_rep_after_change = "Object 'Parent' at world (20.00, 10.00), local (20.00, 10.00)"
        self.assertEqual(parent_rep_after_child_update, expected_parent_rep_after_change)
        self.assertFalse(parent_obj.is_dirty(), "Parent's representation should be clean after its own get_representation call.")
        self.assertFalse(parent_obj._is_world_transform_dirty, "Parent's transform should remain clean.")
    ...
    def test_reparenting_marks_child_dirty(self):
        ...
        self.assertTrue(child.is_dirty(), "Child representation should be dirty after reparenting.")
        self.assertTrue(child._is_world_transform_dirty, "Child transform should be dirty after reparenting.")
    ...
    def test_changing_child_local_transform_does_not_dirty_parent(self):
        ...
        self.assertFalse(parent.is_dirty(), "Parent representation should NOT be dirty when child\'s local transform changes.")
        self.assertFalse(parent._is_world_transform_dirty, "Parent transform should NOT be dirty when child\'s local transform changes.")
        ...
        expected_parent_rep = "Object \'Parent\' at world (1.00, 1.00), local (1.00, 1.00)"
